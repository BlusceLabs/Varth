# Contributing to Varth

Thank you for your interest in contributing to Varth! This document outlines the process for contributing and the governance model we follow.

## Contributor License Agreement (CLA)

Before we can accept your contribution, you must agree to the **Varth Contributor License Agreement (CLA)**.
...
Varth is licensed under the **Apache License 2.0**. By contributing, you agree that your contributions will be licensed under the same terms.

## Governance

- CAST AI Group, Inc. stewards Varth as the primary maintainer.
