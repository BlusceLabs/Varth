 ...
 *   1. VARTH_SANDBOX env var ("1" or "true", case-insensitive) — explicit sentinel set by container orchestrator
...
export function isInSandboxCluster(): boolean {
	if (process.env.VARTH_SANDBOX === "1" || process.env.VARTH_SANDBOX?.toLowerCase() === "true") return true
