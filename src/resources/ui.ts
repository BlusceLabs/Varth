...
export class ResourceManagerComponent {
	...
	render(width: number): string[] {
		...
		add(` ${this.theme.bold(this.theme.fg("text", "Varth resources"))} ${this.renderSummary()}`)
		lines.push("")
		add(` ${this.renderTabs()}`)
