...
// from a consistent base. Defaults to a dark estimate since most varth users
// run on dark schemes.
...
// Used by varth-minimal-tints to apply auto-contrast text colors.
...
// BG ANSI color conversion utilities — used by varth-minimal-tints to apply
