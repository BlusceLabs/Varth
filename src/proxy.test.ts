...
describe("installProxyAgent", () => {
	...
	it("installs EnvHttpProxyAgent when VARTH_PROXY is set", async () => {
		vi.stubEnv("VARTH_PROXY", "http://localhost:8080")
	...
	it("prefers VARTH_PROXY over HTTP_PROXY", async () => {
		vi.stubEnv("VARTH_PROXY", "http://varth-proxy:9090")
