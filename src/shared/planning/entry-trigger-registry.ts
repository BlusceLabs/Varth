 ...
 * | `VARTH_ACTIVE_FERMENT=<id>` | `extensions/ferment/state.ts:32-35` (`getActiveFermentId`) |
 *
 ...
 * `/ferment new`/`VARTH_ACTIVE_FERMENT`). The registry lets each extension
 ...
 *   `VARTH_ACTIVE_FERMENT=<id>`). Fired once during extension setup.
 */
 ...
 * `/ferment-new`, `VARTH_ACTIVE_FERMENT`).
 */
