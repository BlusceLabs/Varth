 ...
 * - `PLAN_MODE_TOOLS` — {@link https://github.com/castai/varth-dev/blob/master/src/extensions/permissions/index.ts | src/extensions/permissions/index.ts:82–93}
 * - `PLANNING_TOOL_NAMES` — {@link https://github.com/castai/varth-dev/blob/master/src/extensions/ferment/tool-scope.ts | src/extensions/ferment/tool-scope.ts:18–48}
 * - `IMPLEMENTATION_TOOL_NAMES` — {@link https://github.com/castai/varth-dev/blob/master/src/extensions/ferment/tool-scope.ts | src/extensions/ferment/tool-scope.ts:50–84}
 *
 * ## Mode flavours
 *
