...
function usage(code: number): number {
	...
	out("Usage: varth resources [list|status]")
	out("       varth resources enable <resource-id>")
	out("       varth resources disable <resource-id>")
	out("       varth resources set <resource-id> on|off")
	out("       varth resources reset <resource-id>")
	return code
}
