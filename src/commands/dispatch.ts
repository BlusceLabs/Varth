...
/**
 * Decide whether a top-level varth subcommand handles this argv.
 *
...
export async function dispatchSubcommand(args: string[]): Promise<DispatchResult> {
	...
	// `varth claude --help` is a subcommand call — the handler decides what to do.
	// `varth --help` (or `varth -h`) falls here and prints the union view.
