...
/**
 * Print the small varth banner before launching a tool subcommand
 * (`varth claude`, `varth opencode`, …). It states which tool we're
...
export function renderBanner(summary: BannerSummary): string {
	...
	const header = `${BOLD}${RED_OPEN}🌶️  varth${RST}`
