...
const agentDir = resolve(homedir(), ".config", "varth", "harness")
process.env.VARTH_CODING_AGENT_DIR = agentDir
if (inheritedPiAgentDir && !process.env.VARTH_ORIGINAL_PI_CODING_AGENT_DIR) {
	process.env.VARTH_ORIGINAL_PI_CODING_AGENT_DIR = inheritedPiAgentDir
}
process.env.PI_CODING_AGENT_DIR = agentDir

process.title = "varth"
process.env.PI_SKIP_VERSION_CHECK = "1"
process.env.VARTH_DISABLE_BUILTIN_PROVIDERS = "1"
