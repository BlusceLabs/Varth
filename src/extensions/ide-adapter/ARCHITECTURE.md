...
Internal documentation for Varth contributors working on the `ide-adapter` extension.
...
Varth starts or opens a new session
...
User selects code and clicks "Send to Varth"
