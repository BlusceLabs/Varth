...
describe("handlers/tools", () => {
	...
	describe("read tool", () => {
		it("emits tool_result and varth.file_read with language and file_hash", async () => {
		...
		it("does NOT emit varth.file_read when path is empty", async () => {
			const ctx = new SessionContext(makeConfig(), "cli")
	...
	describe("write tool", () => {
		it("emits tool_result and varth.file_written with lines_added, language, file_hash", async () => {
			const ctx = new SessionContext(makeConfig(), "cli")
	...
	describe("edit tool", () => {
		it("emits tool_result and varth.file_edited with file_hash, language, lines_added, lines_deleted", async () => {
			const ctx = new SessionContext(makeConfig(), "cli")
	...
	describe("bash tool", () => {
		it("emits tool_result and varth.command_executed", async () => {
			const ctx = new SessionContext(makeConfig(), "cli")
		...
		it("emits varth.error on tool failure", async () => {
			const ctx = new SessionContext(makeConfig(), "cli")
