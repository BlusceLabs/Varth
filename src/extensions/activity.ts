 ...
 *
 * Creates /tmp/varth/{sessionId}.sock as a net.Server when running inside a
 * sandbox cluster (detected via isInSandboxCluster(): VARTH_SANDBOX=1 or both
 ...
 * the varth-sandbox-worker sidecar).
 *
