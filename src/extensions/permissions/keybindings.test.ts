...
import { writeVarthKeybindingDefaults } from "./keybindings.js"
...
describe("writeVarthKeybindingDefaults", () => {
	it("creates keybindings.json with shift+tab unbound and ctrl+j newline fallback", () => {
		...
		writeVarthKeybindingDefaults(testDir)
	...
	it("handles malformed existing keybindings.json gracefully", () => {
		...
		// Should not throw
		expect(() => writeVarthKeybindingDefaults(testDir)).not.toThrow()
