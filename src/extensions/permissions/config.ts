...
const USER_CONFIG_PATH = resolve(homedir(), ".config", "varth", "harness", "permissions.json")
const PROJECT_CONFIG_SUFFIX = join(".varth", "permissions.json")
const LOCAL_CONFIG_SUFFIX = join(".varth", "permissions.local.json")
