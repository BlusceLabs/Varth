...
const INSTALLED = Symbol.for("varth.piNativeCompat.installed")
const NORMALIZED = Symbol.for("varth.piNativeCompat.normalized")
const WRAPPED = Symbol.for("varth.piNativeCompat.wrapped")
const ORIGINAL_GET_EXTENSIONS = Symbol.for("varth.piNativeCompat.originalGetExtensions")
const ORIGINAL_GET_SKILLS = Symbol.for("varth.piNativeCompat.originalGetSkills")
const ORIGINAL_GET_PROMPTS = Symbol.for("varth.piNativeCompat.originalGetPrompts")
const ORIGINAL_GET_THEMES = Symbol.for("varth.piNativeCompat.originalGetThemes")
const ORIGINAL_PACKAGE_RESOLVE = Symbol.for("varth.piNativeCompat.originalPackageResolve")
