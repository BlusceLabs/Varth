 ...
 *   1. Package: each installed varth extension's <pkg>/agents/*.md (lowest)
 *   2. Global:  $VARTH_CODING_AGENT_DIR/agents/*.md (default: ~/.config/varth/harness/agents/*.md)
 *   3. Project: <cwd>/.varth/agents/*.md (highest — overrides everything)
 */
...
export function loadCustomAgents(cwd: string): Map<string, AgentConfig> {
	...
	const projectDir = join(cwd, ".varth", "agents")
