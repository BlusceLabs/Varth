...
export const VARTH_COAUTHOR = "Co-Authored-By: Varth <noreply@varth.dev>"
...
- **Git commits**: Always end every commit message with a blank line followed by \`${VARTH_COAUTHOR}\`.`
