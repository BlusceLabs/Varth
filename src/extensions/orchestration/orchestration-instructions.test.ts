...
describe("resolveOrchestrationInstructions", () => {
	...
	it("shows model IDs from the roles config", () => {
		...
		expect(result).toContain("varth-dev/nemotron-3-ultra-fp4")
	})
	...
	it("renders multiple models per role when configured as array", () => {
		const result = resolveAsString({
			...
			roles: {
				...
				planner: "varth-dev/kimi-k2.6",
				builder: ["varth-dev/minimax-m2.7", "varth-dev/kimi-k2.6"],
				reviewer: ["varth-dev/kimi-k2.6", "varth-dev/minimax-m2.7"],
				explorer: "varth-dev/nemotron-3-ultra-fp4",
				researcher: "varth-dev/nemotron-3-ultra-fp4",
	...
	it("shows external model with custom config in Your Team with tier and description", () => {
		...
		const result = resolveAsString({
			...
			roles: {
				...
				explorer: "varth-dev/nemotron-3-super-fp4",
				researcher: "varth-dev/nemotron-3-super-fp4",
				judge: "varth-dev/kimi-k2.6",
			},
			customConfigs,
		})
