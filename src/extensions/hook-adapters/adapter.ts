...
async function runPreToolUse(
	...
	if (result.updatedInput) Object.assign(event.input, varthToolInput(result.updatedInput, event.input))
...
function hookEnv(payload: Record<string, unknown>, extra?: Record<string, string>): NodeJS.ProcessEnv {
	...
	return {
		...process.env,
		...extra,
		VARTH_HOOK_EVENT: eventName,
		VARTH_TOOL_NAME: toolName,
	}
}
