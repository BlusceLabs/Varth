...
type PatchableAgentSession = {
	prototype: {
		...
		_varthCloudflare524RetryPatch?: boolean
	}
}
 ...
 * but not Cloudflare's 524 timeout, which varth-dev's gateway can return for a
...
export function installCloudflare524RetryPatch(
	...
	if (proto._varthCloudflare524RetryPatch) return
	...
	proto._varthCloudflare524RetryPatch = true
}
