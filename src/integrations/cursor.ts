 ...
 * layer. Alias those substrings so Cursor always routes through varth's gateway
...
/**
 * Mutate Cursor's reactive-storage blob in place to point at the varth
 ...
 * pre-existing model lists are preserved (varth models are added
 * uniquely, no clobber).
 *
...
async function writeCursor(
	...
	// bun:sqlite is built into the compiled varth binary and into `bun run`.
