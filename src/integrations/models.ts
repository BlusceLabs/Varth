...
export const MAIN_MODEL: VarthModel = {
	slug: "minimax-m3",
...
export const KIMI_K25_MODEL: VarthModel = {
	slug: "kimi-k2.5",
...
export const CODING_MODEL: VarthModel = {
...
export const SUB_MODEL: VarthModel = {
	slug: "minimax-m2.7",
...
export const OPUS_MODEL: VarthModel = {
...
export const SONNET_MODEL: VarthModel = {
...
export const ALL_MODELS: ReadonlyArray<VarthModel> = [
	MAIN_MODEL,
	CODING_MODEL,
	SUB_MODEL,
	OPUS_MODEL,
