 ...
 * varth process is single-threaded and there's no second consumer of
 * this file.
 */
...
/** Honors $VARTH_NO_UPDATE_CHECK=<anything-truthy>. */
export function isUpdateCheckDisabled(): boolean {
	const v = process.env.VARTH_NO_UPDATE_CHECK
