 ...
 * renderer that reads Varth templates from VARTH_OAUTH_TEMPLATE_DIR.
 ...
 * upstream's Pi-branded fallback (varth shipping competitor branding is the
...
function renderPage(options) {
    const templateDir = process.env.VARTH_OAUTH_TEMPLATE_DIR;
    if (templateDir) {
        try {
