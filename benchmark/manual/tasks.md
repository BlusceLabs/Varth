...
- Put the code in directory: rate-limiter/
- Include a README.md explaining usage
- Switch the main model to another available model in the varth-dev provider every time you change the phase. Use the /model command or the model switching capability to do this.
```
