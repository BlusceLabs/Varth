...
BINARY=$(python3 -c "import json,os; cfg=json.load(open('$BENCHMARK_JSON')); print(os.path.expanduser(cfg.get('binary','~/_dev/varth-dev/dist/bin/varth')))")
...
DIR=$(mktemp -d /private/tmp/varth-{slug}-XXXXXX)
